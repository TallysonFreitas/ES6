...
var array = ['Tallyson Vieira', 'Fillipe Medeiros', 'Kaique Medeiros', 'Nicolas Nobrega', 'Eduardo Paulino', 'Tallyson Vieira', 'Fillipe Medeiros', 'Kaique Medeiros'];
var arraySet = new Set([].concat(array));
console.log(arraySet);
var arrayNoDuplicate = _toConsumableArray(arraySet);