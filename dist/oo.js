...
var Pokemon = /*#__PURE__*/function () {
  ...
  _createClass(Pokemon, [{
    ...
    key: "atacado",
    value: function atacado(dano) {
      _classPrivateFieldSet(this, _hp, _classPrivateFieldGet(this, _hp) - dano);
      console.log("".concat(this.nome, " recebeu um ataque e sofreu ").concat(dano, " de dano"));
      console.log("resta ".concat(_classPrivateFieldGet(this, _hp), " de hp"));
    }
  }, {
    key: "exibeHp",
